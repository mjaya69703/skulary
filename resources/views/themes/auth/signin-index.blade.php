...
@section('content')
    <div>
        ...
        <div>
            ...
            <form action="{{ route('auth.handle-signin') }}" method="POST">
                @csrf
                <div class="space-y-5">
                    <!-- Email -->
                    <div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="/reset-password.html" class="text-sm text-brand-500 hover:text-brand-600 dark:text-brand-400">Forgot
                            password?</a>
                    </div>
                    <!-- Button -->
                    <div>
            ...
            <div class="mt-5">
                <p class="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                    ...
                    <a href="/signup.html" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Sign Up</a>
                </p>
            </div>
        </div>
    </div>
